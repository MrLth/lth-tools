...
function computedLayoutValue(v) {
  if ((0, lodash_es_1.isNumber)(v)) {
    return v * 4;
  }

  if (/^([0-9.]+)(g)$/i.test(v)) {
    return (0, lodash_es_1.clamp)(parseInt(v, 10), 0, 24) * GRID_UNIT + "vw";
  }
...
exports.default = function (props, componentStyle) {
  return (0, react_1.useMemo)(function () {
    ...
    for (var _iterator = _createForOfIteratorHelperLoose(shortcuts), _step; !(_step = _iterator()).done;) {
      ...
      if (k in props) {
        ...
        if ((0, lodash_es_1.isArray)(cssProperty)) {
    ...
    return Object.assign(css, componentStyle, (0, lodash_es_1.omit)(props, omitKeys), props.style);
